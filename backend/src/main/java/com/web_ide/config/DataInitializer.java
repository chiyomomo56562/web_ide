...
public class DataInitializer {
    ...
    public CommandLineRunner initData(UserRepository userRepository, ProjectRepository projectRepository) {
        return args -> {
            User user1 = userRepository.save(new User("asdf1", "asdf", "user1@example.com", "user1"));
            User user2 = userRepository.save(new User("asdf2", "asdf", "user2@example.com", "user2"));
            User user3 = userRepository.save(new User("asdf3", "asdf", "user3@example.com", "user3"));
